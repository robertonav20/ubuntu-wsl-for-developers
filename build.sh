...
echo "Exporting Container ubuntu-wsl:1.3.0 as archive"
docker stop ubuntu-wsl || true && docker rm ubuntu-wsl || true
docker run --name ubuntu-wsl -it ubuntu-wsl:1.3.0 bash -C exit
docker export --output ubuntu-wsl-1.3.0.tar ubuntu-wsl
